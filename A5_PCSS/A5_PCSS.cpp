...
int main() {
	...
	load_glsl_and_compile("../../A5_PCSS/shaders/shader.vert", &vertex_byte_code, &vertex_code_size, SHADER_TYPE_VERTEX);

	uint8_t* fragment_byte_code = 0;
	int fragment_code_size;
	load_glsl_and_compile("../../A5_PCSS/shaders/shader.frag", &fragment_byte_code, &fragment_code_size, SHADER_TYPE_FRAGMENT);
	...
	load_glsl_and_compile("../../A5_PCSS/shaders/shadowmap.vert", &vertex_byte_code, &vertex_code_size, SHADER_TYPE_VERTEX);
	load_glsl_and_compile("../../A5_PCSS/shaders/shadowmap.frag", &fragment_byte_code, &fragment_code_size, SHADER_TYPE_FRAGMENT);
	...
	Model model_plane = create_model_from_file("../../assets/obj/plane.obj");
	...
	Model model_tree = create_model_from_file("../../assets/obj/tree_single.obj");
	...
	Model model_light = create_model_from_file("../../assets/obj/sphere_mit.obj");
	...
	Image sand_image = load_image("../../assets/textures/sand_diffuse.jpg");
	Image tree_image = load_image("../../assets/textures/sand_diffuse.jpg");
