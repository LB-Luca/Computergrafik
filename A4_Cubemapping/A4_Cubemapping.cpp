...
int main() {
	...
	read_file("../../A4_Cubemapping/shaders/scene_vert.spv", &vertex_byte_code, &vertex_code_size);
	uint8_t * fragment_byte_code = 0;
	int fragment_code_size;
	read_file("../../A4_Cubemapping/shaders/scene_frag.spv", &fragment_byte_code, &fragment_code_size);
    ...
    // Skybox shader
    read_file("../../A4_Cubemapping/shaders/skybox_vert.spv", &vertex_byte_code, &vertex_code_size);
	read_file("../../A4_Cubemapping/shaders/skybox_frag.spv", &fragment_byte_code, &fragment_code_size);
	...
	// Cubemap Textures
	Image cubemap_posx = load_image("../../assets/textures/mountains_cubemap/posx.jpg");
	Image cubemap_negx = load_image("../../assets/textures/mountains_cubemap/negx.jpg");
	Image cubemap_posy = load_image("../../assets/textures/mountains_cubemap/posy.jpg");
	Image cubemap_negy = load_image("../../assets/textures/mountains_cubemap/negy.jpg");
	Image cubemap_posz = load_image("../../assets/textures/mountains_cubemap/posz.jpg");
	Image cubemap_negz = load_image("../../assets/textures/mountains_cubemap/negz.jpg");
	Image cubemap_array[] = {
	...
	// Models
	Model model = create_model_from_file("../../assets/obj/sphere_mit.obj");
	...
	Model model_small = create_model_from_file("../../assets/obj/sphere_mit.obj");
