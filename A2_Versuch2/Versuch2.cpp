...
std::vector<uint32_t> base_tetraeder_indices = {
	2, 1, 0,
	1, 2, 3,
	3, 2, 0,
	0, 1, 3
...
void setupGeometry(int depth, float scale, glm::mat4 transmatrix, std::vector<Vertex> &vertices, std::vector<uint32_t> &indices) {
	if(depth == 0){
